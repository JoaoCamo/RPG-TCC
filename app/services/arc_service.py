...
def generate_arc(selected_model: str, last_action: str, current_arc: int, is_ending: bool):
    ...
    arc_user = f"""
        ...
        IMPORTANT NARRATIVE RULES:
            - The continuation must be told strictly by a NARRATOR.
            - The narrative must NOT be written as dialogue with NPCs.
            - The continuation must introduce a NEW location for the campaign.
            - Do NOT bring back or continue interactions with the previous NPC.
            - The new scene must start with a different environment, atmosphere, and situation.
        ...
        If isEnding = {is_ending}, this is the **final conclusion of the entire story**, not an arc:
            ...
            - Maintain narration-only style (no NPC dialogue).
        ...
        If isEnding = {is_ending}:
            ...
            - The story MUST begin in a new location with no continuation of previous NPC interactions.
